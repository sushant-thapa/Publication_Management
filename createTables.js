...
var commandCreateAuthorTable="CREATE TABLE author(author_id INT AUTO_INCREMENT PRIMARY KEY,first_name VARCHAR(255),second_name VARCHAR(255))"; // correct it please
