...
var dataRecord = new Datastore({filename:"C:/Users/thapa/nedbPractice/data/totalData.txt"}) // opening the file totalData.txt
dataRecord.loadDatabase(function(err){				
	if(err) throw err;
	dataRecord.insert(sampleRecord,function(err,res) // insert the data into totalData.txt
	{
		if(err) throw err;
